...
// ⚠️ Données BRVM factuelles (Juin 2026). Référence éducative uniquement.
...
export const PRODUITS = [
  ...
  },
  {
    id: 'pack',
    nom: 'Pack Complet',
    sousTitre: 'Guide + Calculateur Excel V12',
    prix: '24,99 €',
    lien: LIENS.pack,
    populaire: true,
    points: [
      'Le Guide PDF complet',
      'Le Calculateur Excel V12 (10 onglets)',
...
export const SOLUTIONS = [
  ...
  },
  {
    ...
    texte: 'Flat Tax 30 %, formulaires 3916 / 2047 / 2074 et conventions fiscales expliqués.',
  },
  {
...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    r: 'Oui. Un compte détenu à l’étranger doit être déclaré via le formulaire 3916, sous peine d’une amende de 1 500 € par an. Les dividendes sont imposés au PFU (Flat Tax) de 30 %. Le guide détaille la marche à suivre.',
  },
  {
