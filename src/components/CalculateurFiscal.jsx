...
const PAYS = [
  {
    ...
    obligations: [
      ...
      { label: 'Formulaire 2047', detail: "Déclaration des revenus encaissés à l'étranger. Reporter les dividendes bruts reçus." },
      { label: 'Case 2DC (2042)', detail: "Reporter le total des dividendes bruts sur votre déclaration principale. La flat tax de 30% s'applique automatiquement." },
    ],
    note: "La convention fiscale CI-France (1966) permet d'imputer la retenue à la source de 10% sur votre flat tax (12,8%). Vous ne payez donc que 20% supplémentaires en France au lieu de 30%.",
    highlight: 'Pays le plus favorable grâce à la convention fiscale',
  },
  {
    code: 'BE',
    nom: 'Belgique',
  ...
  },
  {
    ...
    note: "En tant que résident UEMOA, la retenue à la source de 6% est libératoire : c'est votre imposition finale sur les dividendes BRVM. Aucune déclaration supplémentaire requise.",
    highlight: 'Imposition la plus simple — retenue libératoire',
  },
  {
    code: 'CI',
    nom: "Côte d'Ivoire",
  ...
  },
  {
    ...
    note: 'Résidents UEMOA : retenue à la source de 6% libératoire sur dividendes BRVM.',
    highlight: null,
  },
  {
    code: 'ML',
