...
const PAYS = [
  {
    ...
    obligations: [
      ...
      { label: 'Case 2DC (2042)', detail: "Reporter le total des dividendes bruts sur votre déclaration principale. La flat tax (PFU) de 31,4% s'applique sur le brut." },
    ],
    note: "Retenue BRVM (CI) : 10% prélevée à la source, non récupérable sous le PFU. La flat tax française de 31,4% (12,8% IR + 18,6% PS, taux 2026) s'applique sur le brut → charge totale de 41,4%. Convention CI-France (1966) : si vous optez pour le barème progressif à la place du PFU, la retenue de 10% peut être créditée sur votre IR (hors prélèvements sociaux). Consultez un fiscaliste pour optimiser selon votre tranche.",
    highlight: null,
  },
  {
    code: 'BE',
